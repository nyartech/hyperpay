...
/**
 ...
 @warning **Deprecated:** Use `-addParamWithName:value:` instead.
 */
- (BOOL)addCustomParamWithName:(NSString *)name value:(NSString *)value DEPRECATED_MSG_ATTRIBUTE("- Use -addParamWithName:value: instead.");

/**
 Method to remove record from the dictionary of custom parameters.
 @param name Parameter name.
 
 @warning **Deprecated:** Use `-removeParamWithName:` instead.
  */
